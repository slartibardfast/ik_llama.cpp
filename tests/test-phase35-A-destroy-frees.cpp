// Phase 35 A.T5: cudaGraphExecDestroy free-delta probe.
//
...
// non-negative free_after_bytes. Probes the precondition for Phase E:
// if delta_bytes is consistently 0 across many destroys, eviction
// won't relieve VRAM pressure (cuda_pool retains memory).
//
// RED at A.0; GREEN after A.6 (destroy-frees probe).
...
int main() {
    char dir_template[] = "phase35-A-destroy-XXXXXX";
    ...
    printf("=== test-phase35-A-destroy-frees ===\n");
