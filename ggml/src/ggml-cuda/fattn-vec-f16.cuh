...
#pragma unroll
            for (int i0 = 0; i0 < Dk/sizeof(int); i0 += WARP_SIZE) {
                quantize_q8_1_to_shared<half2>(Q_f + 4*i0, scale, tmp_q_i32 + i0, tmp_q_ds + i0/QI8_1);
            }
        }
...
// FIX-C v4 (2026-05-16): per-slot-kv production routes here for batch-invariance.
extern DECL_FATTN_VEC_F16_CASE(256, GGML_TYPE_Q4_0, GGML_TYPE_Q4_0);
