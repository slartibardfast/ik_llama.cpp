...
#undef CREATE_MM
    ...
    const bool has_sg = false; // TODO: debug subgroupAdd on RDNA2
    ...
    for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q2_K][i], "mul_mat_vec_q2_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q2_k_f32_f32_len, mul_mat_vec_q2_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q2_k_f32_f32_data, mul_mat_vec_q2_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q3_k_f32_f32_len, mul_mat_vec_q3_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q3_k_f32_f32_data, mul_mat_vec_q3_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q4_K][i], "mul_mat_vec_q4_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q4_k_f32_f32_len, mul_mat_vec_q4_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q4_k_f32_f32_data, mul_mat_vec_q4_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q5_K][i], "mul_mat_vec_q5_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q5_k_f32_f32_len, mul_mat_vec_q5_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q5_k_f32_f32_data, mul_mat_vec_q5_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q6_K][i], "mul_mat_vec_q6_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q6_k_f32_f32_len, mul_mat_vec_q6_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q6_k_f32_f32_data, mul_mat_vec_q6_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ1_S][i],   "mul_mat_vec_iq1_s_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_s_f32_f32_len, mul_mat_vec_iq1_s_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_s_f32_f32_data, mul_mat_vec_iq1_s_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ1_M][i],   "mul_mat_vec_iq1_m_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_m_f32_f32_len, mul_mat_vec_iq1_m_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_m_f32_f32_data, mul_mat_vec_iq1_m_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ2_XXS][i], "mul_mat_vec_iq2_xxs_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_iq2_xxs_f32_f32_len, mul_mat_vec_iq2_xxs_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_iq2_xxs_f32_f32_data, mul_mat_vec_iq2_xxs_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ2_S][i],   "mul_mat_vec_iq2_s_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq2_s_f32_f32_len, mul_mat_vec_iq2_s_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq2_s_f32_f32_data, mul_mat_vec_iq2_s_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ3_XXS][i], "mul_mat_vec_iq3_xxs_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_iq3_xxs_f32_f32_len, mul_mat_vec_iq3_xxs_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_iq3_xxs_f32_f32_data, mul_mat_vec_iq3_xxs_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ3_S][i],   "mul_mat_vec_iq3_s_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq3_s_f32_f32_len, mul_mat_vec_iq3_s_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq3_s_f32_f32_data, mul_mat_vec_iq3_s_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ4_XS][i],  "mul_mat_vec_iq4_xs_f32_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_xs_f32_f32_len, mul_mat_vec_iq4_xs_f32_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_xs_f32_f32_data, mul_mat_vec_iq4_xs_f32_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ4_NL][i],  "mul_mat_vec_iq4_nl_f32_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_nl_f32_f32_len, mul_mat_vec_iq4_nl_f32_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_nl_f32_f32_data, mul_mat_vec_iq4_nl_f32_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q3_k_f16_f32_len, mul_mat_vec_q3_k_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q3_k_f16_f32_data, mul_mat_vec_q3_k_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_Q4_K][i], "mul_mat_vec_q4_k_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q4_k_f16_f32_len, mul_mat_vec_q4_k_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q4_k_f16_f32_data, mul_mat_vec_q4_k_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_IQ1_M][i],   "mul_mat_vec_iq1_m_f16_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_m_f16_f32_len, mul_mat_vec_iq1_m_f16_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_m_f16_f32_data, mul_mat_vec_iq1_m_f16_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_IQ2_S][i],   "mul_mat_vec_iq2_s_f16_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq2_s_f16_f32_len, mul_mat_vec_iq2_s_f16_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq2_s_f16_f32_data, mul_mat_vec_iq2_s_f16_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_IQ3_XXS][i], "mul_mat_vec_iq3_xxs_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_iq3_xxs_f16_f32_len, mul_mat_vec_iq3_xxs_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_iq3_xxs_f16_f32_data, mul_mat_vec_iq3_xxs_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[GGML_TYPE_Q2_K], "mul_mat_vec_id_q2_k_f32", sg_len(mul_mat_vec_id_q2_k_f32_len, mul_mat_vec_id_q2_k_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_id_q2_k_f32_data, mul_mat_vec_id_q2_k_f32_subgroup_data, subgroup_size_16), "main", 6, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq}, 1, true);
    ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[GGML_TYPE_Q3_K], "mul_mat_vec_id_q3_k_f32", sg_len(mul_mat_vec_id_q3_k_f32_len, mul_mat_vec_id_q3_k_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_id_q3_k_f32_data, mul_mat_vec_id_q3_k_f32_subgroup_data, subgroup_size_16), "main", 6, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq}, 1, true);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[GGML_TYPE_Q6_K], "mul_mat_vec_id_q6_k_f32", sg_len(mul_mat_vec_id_q6_k_f32_len, mul_mat_vec_id_q6_k_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_id_q6_k_f32_data, mul_mat_vec_id_q6_k_f32_subgroup_data, subgroup_size_16), "main", 6, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq}, 1, true);
    ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[GGML_TYPE_IQ1_S],   "mul_mat_vec_id_iq1_s_f32",   sg_len(mul_mat_vec_id_iq1_s_f32_len, mul_mat_vec_id_iq1_s_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_id_iq1_s_f32_data, mul_mat_vec_id_iq1_s_f32_subgroup_data, subgroup_size_16),   "main", 6, sizeof(vk_mat_vec_id_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq}, 1, true);
    ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[GGML_TYPE_IQ1_M],   "mul_mat_vec_id_iq1_m_f32",   sg_len(mul_mat_vec_id_iq1_m_f32_len, mul_mat_vec_id_iq1_m_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_id_iq1_m_f32_data, mul_mat_vec_id_iq1_m_f32_subgroup_data, subgroup_size_16),   "main", 6, sizeof(vk_mat_vec_id_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq}, 1, true);
    ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[GGML_TYPE_IQ2_XXS], "mul_mat_vec_id_iq2_xxs_f32", sg_len(mul_mat_vec_id_iq2_xxs_f32_len, mul_mat_vec_id_iq2_xxs_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_id_iq2_xxs_f32_data, mul_mat_vec_id_iq2_xxs_f32_subgroup_data, subgroup_size_16), "main", 6, sizeof(vk_mat_vec_id_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq}, 1, true);
