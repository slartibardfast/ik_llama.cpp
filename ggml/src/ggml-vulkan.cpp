...
#undef CREATE_MM
    ...
    for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_F32 ][i], "mul_mat_vec_f32_f32_f32_"+std::to_string(i+1),  mul_mat_vec_f32_f32_f32_len,  mul_mat_vec_f32_f32_f32_data,  "main", 5, sizeof(vk_mat_vec_push_constants), {2, 1, 1}, {device->subgroup_size, 2, i+1}, 1);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_F16 ][i], "mul_mat_vec_f16_f32_f32_"+std::to_string(i+1),  mul_mat_vec_f16_f32_f32_len,  mul_mat_vec_f16_f32_f32_data,  "main", 5, sizeof(vk_mat_vec_push_constants), {2, 1, 1}, {device->subgroup_size, 2, i+1}, 1);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_BF16][i], "mul_mat_vec_bf16_f32_f32_"+std::to_string(i+1), mul_mat_vec_bf16_f32_f32_len, mul_mat_vec_bf16_f32_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {2, 1, 1}, {device->subgroup_size, 2, i+1}, 1);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q4_0][i], "mul_mat_vec_q4_0_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q4_0_f32_f32_len, mul_mat_vec_q4_0_f32_f32_subgroup_len, device->subgroup_size), sg_data(mul_mat_vec_q4_0_f32_f32_data, mul_mat_vec_q4_0_f32_f32_subgroup_data, device->subgroup_size), "main", 5, sizeof(vk_mat_vec_push_constants), {2*rm_stdq, 1, 1}, {device->subgroup_size, 2*rm_stdq, i+1}, 1, true, has_sg && device->subgroup_size == device->subgroup_size, has_sg && device->subgroup_size == device->subgroup_size ? device->subgroup_size : 0);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q8_0][i], "mul_mat_vec_q8_0_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q8_0_f32_f32_len, mul_mat_vec_q8_0_f32_f32_subgroup_len, device->subgroup_size), sg_data(mul_mat_vec_q8_0_f32_f32_data, mul_mat_vec_q8_0_f32_f32_subgroup_data, device->subgroup_size), "main", 5, sizeof(vk_mat_vec_push_constants), {1*rm_stdq, 1, 1}, {device->subgroup_size, 1*rm_stdq, i+1}, 1, true, has_sg && device->subgroup_size == device->subgroup_size, has_sg && device->subgroup_size == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q2_K][i], "mul_mat_vec_q2_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q2_k_f32_f32_len, mul_mat_vec_q2_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q2_k_f32_f32_data, mul_mat_vec_q2_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q3_k_f32_f32_len, mul_mat_vec_q3_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q3_k_f32_f32_data, mul_mat_vec_q3_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q4_K][i], "mul_mat_vec_q4_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q4_k_f32_f32_len, mul_mat_vec_q4_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q4_k_f32_f32_data, mul_mat_vec_q4_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q5_K][i], "mul_mat_vec_q5_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q5_k_f32_f32_len, mul_mat_vec_q5_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q5_k_f32_f32_data, mul_mat_vec_q5_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_Q6_K][i], "mul_mat_vec_q6_k_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q6_k_f32_f32_len, mul_mat_vec_q6_k_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q6_k_f32_f32_data, mul_mat_vec_q6_k_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ1_S][i],   "mul_mat_vec_iq1_s_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_s_f32_f32_len, mul_mat_vec_iq1_s_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_s_f32_f32_data, mul_mat_vec_iq1_s_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ1_M][i],   "mul_mat_vec_iq1_m_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_m_f32_f32_len, mul_mat_vec_iq1_m_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_m_f32_f32_data, mul_mat_vec_iq1_m_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ2_XXS][i], "mul_mat_vec_iq2_xxs_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_iq2_xxs_f32_f32_len, mul_mat_vec_iq2_xxs_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_iq2_xxs_f32_f32_data, mul_mat_vec_iq2_xxs_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ2_S][i],   "mul_mat_vec_iq2_s_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq2_s_f32_f32_len, mul_mat_vec_iq2_s_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq2_s_f32_f32_data, mul_mat_vec_iq2_s_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ3_XXS][i], "mul_mat_vec_iq3_xxs_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_iq3_xxs_f32_f32_len, mul_mat_vec_iq3_xxs_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_iq3_xxs_f32_f32_data, mul_mat_vec_iq3_xxs_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ3_S][i],   "mul_mat_vec_iq3_s_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq3_s_f32_f32_len, mul_mat_vec_iq3_s_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq3_s_f32_f32_data, mul_mat_vec_iq3_s_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ4_XS][i],  "mul_mat_vec_iq4_xs_f32_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_xs_f32_f32_len, mul_mat_vec_iq4_xs_f32_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_xs_f32_f32_data, mul_mat_vec_iq4_xs_f32_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[GGML_TYPE_IQ4_NL][i],  "mul_mat_vec_iq4_nl_f32_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_nl_f32_f32_len, mul_mat_vec_iq4_nl_f32_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_nl_f32_f32_data, mul_mat_vec_iq4_nl_f32_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);

        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_F32 ][i], "mul_mat_vec_f32_f16_f32_"+std::to_string(i+1),  mul_mat_vec_f32_f16_f32_len,  mul_mat_vec_f32_f16_f32_data,  "main", 5, sizeof(vk_mat_vec_push_constants), {2, 1, 1}, {device->subgroup_size, 2, i+1}, 1);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_F16 ][i], "mul_mat_vec_f16_f16_f32_"+std::to_string(i+1),  mul_mat_vec_f16_f16_f32_len,  mul_mat_vec_f16_f16_f32_data,  "main", 5, sizeof(vk_mat_vec_push_constants), {2, 1, 1}, {device->subgroup_size, 2, i+1}, 1);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_BF16][i], "mul_mat_vec_bf16_f16_f32_"+std::to_string(i+1), mul_mat_vec_bf16_f16_f32_len, mul_mat_vec_bf16_f16_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {2, 1, 1}, {device->subgroup_size, 2, i+1}, 1);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q3_k_f16_f32_len, mul_mat_vec_q3_k_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q3_k_f16_f32_data, mul_mat_vec_q3_k_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_Q4_K][i], "mul_mat_vec_q4_k_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q4_k_f16_f32_len, mul_mat_vec_q4_k_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q4_k_f16_f32_data, mul_mat_vec_q4_k_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_Q6_K][i], "mul_mat_vec_q6_k_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q6_k_f16_f32_len, mul_mat_vec_q6_k_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q6_k_f16_f32_data, mul_mat_vec_q6_k_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_IQ1_M][i],   "mul_mat_vec_iq1_m_f16_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_m_f16_f32_len, mul_mat_vec_iq1_m_f16_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_m_f16_f32_data, mul_mat_vec_iq1_m_f16_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_IQ2_S][i],   "mul_mat_vec_iq2_s_f16_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq2_s_f16_f32_len, mul_mat_vec_iq2_s_f16_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq2_s_f16_f32_data, mul_mat_vec_iq2_s_f16_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[GGML_TYPE_IQ3_XXS][i], "mul_mat_vec_iq3_xxs_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_iq3_xxs_f16_f32_len, mul_mat_vec_iq3_xxs_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_iq3_xxs_f16_f32_data, mul_mat_vec_iq3_xxs_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        ...
        if (device->architecture == AMD_GCN5 && device->fp16) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f32_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_f16acc_f32_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q3_k_f16acc_f32_f32_len, mul_mat_vec_q3_k_f16acc_f32_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q3_k_f16acc_f32_f32_data, mul_mat_vec_q3_k_f16acc_f32_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f32_f32[GGML_TYPE_IQ2_S][i],   "mul_mat_vec_iq2_s_f16acc_f32_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq2_s_f16acc_f32_f32_len, mul_mat_vec_iq2_s_f16acc_f32_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq2_s_f16acc_f32_f32_data, mul_mat_vec_iq2_s_f16acc_f32_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f32_f32[GGML_TYPE_IQ4_XS][i],  "mul_mat_vec_iq4_xs_f16acc_f32_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_xs_f16acc_f32_f32_len, mul_mat_vec_iq4_xs_f16acc_f32_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_xs_f16acc_f32_f32_data, mul_mat_vec_iq4_xs_f16acc_f32_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f32_f32[GGML_TYPE_IQ4_NL][i],  "mul_mat_vec_iq4_nl_f16acc_f32_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_nl_f16acc_f32_f32_len, mul_mat_vec_iq4_nl_f16acc_f32_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_nl_f16acc_f32_f32_data, mul_mat_vec_iq4_nl_f16acc_f32_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f16_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_f16acc_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q3_k_f16acc_f16_f32_len, mul_mat_vec_q3_k_f16acc_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q3_k_f16acc_f16_f32_data, mul_mat_vec_q3_k_f16acc_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f16_f32[GGML_TYPE_Q4_K][i], "mul_mat_vec_q4_k_f16acc_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q4_k_f16acc_f16_f32_len, mul_mat_vec_q4_k_f16acc_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q4_k_f16acc_f16_f32_data, mul_mat_vec_q4_k_f16acc_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f16_f32[GGML_TYPE_Q5_K][i], "mul_mat_vec_q5_k_f16acc_f16_f32_"+std::to_string(i+1), sg_len(mul_mat_vec_q5_k_f16acc_f16_f32_len, mul_mat_vec_q5_k_f16acc_f16_f32_subgroup_len, subgroup_size_16), sg_data(mul_mat_vec_q5_k_f16acc_f16_f32_data, mul_mat_vec_q5_k_f16acc_f16_f32_subgroup_data, subgroup_size_16), "main", 5, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {subgroup_size_16, rm_kq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f16_f32[GGML_TYPE_IQ1_S][i],   "mul_mat_vec_iq1_s_f16acc_f16_f32_"+std::to_string(i+1),   sg_len(mul_mat_vec_iq1_s_f16acc_f16_f32_len, mul_mat_vec_iq1_s_f16acc_f16_f32_subgroup_len, subgroup_size_16),   sg_data(mul_mat_vec_iq1_s_f16acc_f16_f32_data, mul_mat_vec_iq1_s_f16acc_f16_f32_subgroup_data, subgroup_size_16),   "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f16_f32[GGML_TYPE_IQ4_XS][i],  "mul_mat_vec_iq4_xs_f16acc_f16_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_xs_f16acc_f16_f32_len, mul_mat_vec_iq4_xs_f16acc_f16_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_xs_f16acc_f16_f32_data, mul_mat_vec_iq4_xs_f16acc_f16_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16acc_f16_f32[GGML_TYPE_IQ4_NL][i],  "mul_mat_vec_iq4_nl_f16acc_f16_f32_"+std::to_string(i+1),  sg_len(mul_mat_vec_iq4_nl_f16acc_f16_f32_len, mul_mat_vec_iq4_nl_f16acc_f16_f32_subgroup_len, subgroup_size_16),  sg_data(mul_mat_vec_iq4_nl_f16acc_f16_f32_data, mul_mat_vec_iq4_nl_f16acc_f16_f32_subgroup_data, subgroup_size_16),  "main", 5, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {subgroup_size_16, rm_iq, i+1}, 1, true, has_sg && subgroup_size_16 == device->subgroup_size, has_sg && subgroup_size_16 == device->subgroup_size ? device->subgroup_size : 0);
        }
    }
    ...
    if (device->integer_dot_product) {
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q4_0][i], "mul_mat_vec_q4_0_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q4_0_q8_1_f32_len, mul_mat_vec_q4_0_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {device->subgroup_size, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q4_1][i], "mul_mat_vec_q4_1_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q4_1_q8_1_f32_len, mul_mat_vec_q4_1_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {device->subgroup_size, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q5_0][i], "mul_mat_vec_q5_0_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q5_0_q8_1_f32_len, mul_mat_vec_q5_0_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {device->subgroup_size, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q5_1][i], "mul_mat_vec_q5_1_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q5_1_q8_1_f32_len, mul_mat_vec_q5_1_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {device->subgroup_size, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q8_0][i], "mul_mat_vec_q8_0_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q8_0_q8_1_f32_len, mul_mat_vec_q8_0_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {device->subgroup_size, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q2_K][i], "mul_mat_vec_q2_k_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q2_k_q8_1_f32_len, mul_mat_vec_q2_k_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {subgroup_size_16, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q3_K][i], "mul_mat_vec_q3_k_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q3_k_q8_1_f32_len, mul_mat_vec_q3_k_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {subgroup_size_16, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q4_K][i], "mul_mat_vec_q4_k_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q4_k_q8_1_f32_len, mul_mat_vec_q4_k_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {subgroup_size_16, 1, i+1}, 1, true, false, 0);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[GGML_TYPE_Q5_K][i], "mul_mat_vec_q5_k_q8_1_f32_"+std::to_string(i+1), mul_mat_vec_q5_k_q8_1_f32_len, mul_mat_vec_q5_k_q8_1_f32_data, "main", 5, sizeof(vk_mat_vec_push_constants), {1, 1, 1}, {subgroup_size_16, 1, i+1}, 1, true, false, 0);
        }
    }
