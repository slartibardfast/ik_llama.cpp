...
bool gpt_params_find_arg(int argc, char ** argv, const std::string & arg, gpt_params & params, int & i, bool & invalid_param) {
    ...
    if (arg == "--spec-type") {
        ...
        if (value == "none") {
            ...
            throw std::invalid_argument("unknown speculative decoding type: " + value);
        }
        return true;
    }
...
void gpt_params_print_usage(int /*argc*/, char ** argv, const gpt_params & params) {
    ...
    options.push_back({ "*", "--spec-type Name [none | ngram - cache | ngram - simple | ngram - map - k | ngram - map - k4v | ngram - mod | suffix | mtp | dflash]", "type of speculative decoding to use (default: %d)\n", (int)params.speculative.type});
